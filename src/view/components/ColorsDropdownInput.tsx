...
export default function ColorsDropdownInput({ className, error, value, onChange }: ColorsDropdownInputProps) {
    ...
    <div>
      <DropdownMenu.Root>
        <DropdownMenu.Trigger>
          <button className={cn("bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-700 focus:border-gray-800 transition-all outline-none text-left relative",
        ...
        <DropdownMenu.Content className="z-[100] grid grid-cols-4">
          {
            colors.map(color => (
